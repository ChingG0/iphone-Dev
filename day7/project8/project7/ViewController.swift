...
class ViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView,
        ...
        cityCell.cityImageView.layer.cornerRadius = 20.0;
    ...
    override func tableView(_ tableView: UITableView,
        ...
        let optionMenu = UIAlertController(title: nil, message: "您想要去這裡嗎？",
        ...
        let callAction = UIAlertAction(title: "聯絡旅行社", style: .default) {(action:UIAlertAction)in     //closure, 呼叫ViewController的property 和 method必須使用self
